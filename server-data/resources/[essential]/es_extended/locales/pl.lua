Locales['pl'] = {
 ['cash'] = 'Kasa: %s $',
  ...
  ['ex_inv_lim'] = 'działanie nie jest możliwe, przekroczono limit dla ~y~%s~s~',
  ...
  ['weapon_firework'] = 'sztuczne ognie',
  ...
  ['weapon_garbagebag'] = 'worek naśmieci',
