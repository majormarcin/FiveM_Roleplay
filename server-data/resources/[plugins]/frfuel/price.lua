...
if (xPlayer) then
            ...
            TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Cena benzyny to " .. fuelCost) --PL
            ...
            TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Twój pełen bak to " .. round(amount) .. " litrów") --PL
            ...
            TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Całkowity koszt " .. round(cost)) --PL
			...
			TriggerClientEvent('chatMessage', source, "SYSTEM", {255, 0, 0}, "Nie masz wystarczająco pieniędzy") --PL
