...
Config.Animations = {
	...
	},
	{
		...
		label = 'Travail',
		items = {
			{label = "Podejrzany: ręce za głowe", type = "anim", data = {lib = "random@arrests@busted", anim = "idle_c"}},
			{label = "Pêcheur", type = "scenario", data = {anim = "world_human_stand_fishing"}},
			{label = "Policja: zbadaj sprawę", type = "anim", data = {lib = "amb@code_human_police_investigate@idle_b", anim = "idle_f"}},
			{label = "Policja: rozmawiaj przez radio", type = "anim", data = {lib = "random@arrests", anim = "generic_radio_chatter"}},
			{label = "Policja: obieg", type = "scenario", data = {anim = "WORLD_HUMAN_CAR_PARK_ATTENDANT"}},
	...
	},
	{
		...
		label = 'Divers',
		items = {
			{label = "Wypij kawę", type = "anim", data = {lib = "amb@world_human_aa_coffee@idle_a", anim = "idle_a"}},
			{label = "Usiądź", type = "anim", data = {lib = "anim@heists@prison_heistunfinished_biztarget_idle", anim = "target_idle"}},
			{label = "Poczekaj na ścianę", type = "scenario", data = {anim = "world_human_leaning"}},
			{label = "Leżąc na plecach", type = "scenario", data = {anim = "WORLD_HUMAN_SUNBATHE_BACK"}},
			{label = "Leżąc na brzuchu", type = "scenario", data = {anim = "WORLD_HUMAN_SUNBATHE"}},
			{label = "Oczyść coś", type = "scenario", data = {anim = "world_human_maid_clean"}},
