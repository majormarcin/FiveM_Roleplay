Locales['en'] = {
  ...
  ['cloakroom'] = 'Szatnia',
  ['citizen_wear'] = 'Cywil',
  ['police_wear'] = 'Policjant',
  ['sheriff_wear'] = 'Szeryf',
  ['lieutenant_wear'] = 'Oddział specjalny',
  ['gilet_wear'] = 'Przykrywka',
  ...
  ['service_max'] = 'Maksymalna ilość policjantów w służbie: ',
  -- Action Menu
  ...
  ['license_revoked'] = 'Twoje ~b~%s~s~ zostały ~y~unieważnione~s~!',
  ...
  ['not_enough_in_society'] = 'Nie ma wystarczająco dużo tego przedmiotu w społeczeństwie!',
  ['player_cannot_hold'] = '~r~Nie masz~w~ wystarczająco ~y~wolnego miejsca~w~ w Twoim ekwipunku!',
  ['added'] = 'Dodałeś x',
  ['quantity'] = 'Ilość',
  ['inventory'] = 'Ekwipunek',
