...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
	...
	table.insert(elements, { label = 'Bus Transportowy', value = 'policet'})
	...
	table.insert(elements, { label = 'Nieoznakowany Cruiser', value = 'police4'})
    end
    ...
    if PlayerData.job.grade_name == 'boss' then
      ...
      table.insert(elements, { label = 'FBI SUV', value = 'fbi2'})
      table.insert(elements, { label = 'Nieoznakowany Cruiser', value = 'police4'})
	  table.insert(elements, { label = 'AMG', value = 'polamggtr'})
    end
