Locales['pl'] = {
  ...
  ['return_provider']         = 'oddaj pojazd do firmy',
  ...
  ['return_provider_menu']    = 'salon samochodowy - Oddaj pojazd do firmy',
  ...
  ['vehicle_sold_for']        = '~b~%s~s~ zostało ~y~sprzedane~s~ za ~g~$%s~s~',
